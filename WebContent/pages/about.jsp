...
<body>
 <div class="header width_100pre">
    ...
    <div>
        <div class="float_left div_chinese word_style">
            <div class="word_right">
                    匠人之手<br/>
                    曾几何时，历史上出现过无数能工巧匠，他<br/>
                    们在各自领域各展异能，将人类进步的进程<br/>
                    一步步向前推进。而今，悦杰人接过技术改<br/>
                    变历史的刻刀，用匠人般的灵巧之手，镌刻<br/>
                    出时代的烙印。
            </div>
            <div class="word_right margin_top_30">
                    专注之手<br/>
                    专注之手源于专注的心灵。为了完美打造您<br/>
                    心中所想，我们从挖掘您最初的设计需求开<br/>
                    始，建立起您脑海中所想，所求的清晰图像，<br/>
                    用科学的方法，严谨的态度，一步步化虚幻<br/>
                    为真实，为您呈现精妙绝伦的设计作品。
            </div>
        </div>
        <div class="float_left margin_left_30 word_style">
            <div>
            Hands of Craftsmen<br/>
            Once upon a time,there are countless skillful craftsmen,they display<br/>
            their talent in their respective field,and have promoted human progress<br/>
            step by step.Now,Professional in Pleasant Design take the graver,which<br/>
            would change the history with technology,with artisan-like hands of<br/>
    craftsmen,engrave a mark of the times.
            </div>
            <div class="margin_top_30">
            Hands of Attentiveness<br/>
            Hands of Attentiveness originate from inner focus of soul.To prefect-<br/>
            ly create what you thought,we start from digging your initial design<br/>
            needs,building up what is in your mind,seeking for clear image,using<br/>
            scientific method and rigorous attitude,realizing the imagination to<br/>
            reality gradually,and finally present you exquisite design work.<br/>
            </div>
        </div>
