...
<link href="../resources/css/jquery-ui-themes.css" type="text/css" rel="stylesheet"/>
    ...
    <link href="../files/作品欣赏/styles.css" type="text/css" rel="stylesheet"/>
    ...
    <script src="../files/作品欣赏/data.js"></script>
...
<div id="base" class="">
      ...
      <div id="u0" class="ax_image">
        <img id="u0_img" class="img " src="../images/作品欣赏/u0.jpg"/>
        <!-- Unnamed () -->
      ...
      <div id="u17" class="ax_image">
        <img id="u17_img" class="img " src="../images/作品欣赏/u17.jpg"/>
        <!-- Unnamed () -->
