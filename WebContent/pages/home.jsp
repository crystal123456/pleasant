...
<body>
    <div id="base" class="">
      ...
      <!-- 1 (动态面板) -->
      <div id="u2" class="ax_动态面板" data-label="1">
      ...
      <!-- 2 (动态面板) -->
      <div id="u5" class="ax_动态面板" data-label="2">
      ...
      <!-- 3 (动态面板) -->
      <div id="u8" class="ax_动态面板" data-label="3">
      ...
      <!-- 4 (动态面板) -->
      <div id="u11" class="ax_动态面板" data-label="4">
      ...
      <!-- 菜单 (动态面板) -->
      <div id="u16" class="ax_动态面板" data-label="菜单">
        <div id="u16_state0" class="panel_state" data-label="State1">
          <div id="u16_state0_content" class="panel_state_content">
            ...
            <div id="u17" class="ax_image">
              <a href="works.jsp"><img id="u17_img" class="img " src="../images/home/u17.png"/></a>
              <!-- Unnamed () -->
            ...
            <div id="u19" class="ax_image">
              <a href="cooperation.jsp"><img id="u19_img" class="img " src="../images/home/u19.png"/></a>
              <!-- Unnamed () -->
            ...
            <div id="u21" class="ax_image">
              <a href="communication.jsp"><img id="u21_img" class="img " src="../images/home/u21.png"/></a>
              <!-- Unnamed () -->
            ...
            <div id="u23" class="ax_image">
              <a href="about.jsp"><img id="u23_img" class="img " src="../images/home/u23.png"/></a>
              <!-- Unnamed () -->
            ...
            <div id="u25" class="ax_image">
              <a href="joinus.jsp"><img id="u25_img" class="img " src="../images/home/u25.png"/></a>
              <!-- Unnamed () -->
            ...
            <div id="u27" class="ax_image">
              <a href="login.jsp"><img id="u27_img" class="img " src="../images/home/u27.png"/></a>
      ...
      <!-- 联系方式 (动态面板) -->
      <div id="u29" class="ax_动态面板" data-label="联系方式">
        <div id="u29_state0" class="panel_state" data-label="State1">
          <div id="u29_state0_content" class="panel_state_content">
            ...
            <!-- 微信 (动态面板) -->
            <div id="u32" class="ax_动态面板" data-label="微信">
            ...
            <!-- qq (动态面板) -->
            <div id="u37" class="ax_动态面板" data-label="qq">
            ...
            <!-- email (动态面板) -->
            <div id="u40" class="ax_动态面板" data-label="email">
            ...
            <!-- phone (动态面板) -->
            <div id="u43" class="ax_动态面板" data-label="phone">
            ...
            <!-- map (动态面板) -->
            <div id="u48" class="ax_动态面板" data-label="map">
      ...
      <!-- 产品介绍 (动态面板) -->
      <div id="u63" class="ax_动态面板" data-label="产品介绍">
        <div id="u63_state0" class="panel_state" data-label="State1">
